...
document.addEventListener('DOMContentLoaded', function() {
    ...
    filterButton.addEventListener('click', function() {
        ...
        const cheapRestaurants = restaurants.filter(function(restaurant) { return restaurant.priceRange === "$" || restaurant.priceRange === "$$" ; })
        cheapRestaurants.forEach(function(restaurant, index) { 
    ...
    mapButton.addEventListener('click', function() {
        ...
        names.forEach(function(restaurant, index) { 
            mappedList.innerHTML += `<li>${restaurant}</li>`
